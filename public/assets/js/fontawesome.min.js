...
! function () {
	...
	var I = H[u],
		F = [],
		Y = !1;
	c && ((Y = (d.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(d.readyState)) || d.addEventListener("DOMContentLoaded", function t() {
		d.removeEventListener("DOMContentLoaded", t), Y = 1, F.map(function (t) {
			return t()
		})
	}));
	var _ = function (t) {
	...
	var se, le = new(function () {
		...
		ce = {
			...
			watch: function () {
				...
				!1 === T.autoReplaceSvg && (T.autoReplaceSvg = !0), T.observeMutations = !0, _(function () {
					de({
	...
	! function (t) {
		...
		f && (m.FontAwesome || (m.FontAwesome = me), _(function () {
			de(), Et({
				treeCallback: te,
				nodeCallback: ee,
				pseudoElementsCallback: $t
