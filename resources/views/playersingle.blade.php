...
<main role="main">
    ...
    <p><img src="https://clubatletico.bocajuniors.com.ar/images/star.png"><span class="item">Fecha de Nacimiento: </span><span>@isset($player->dob) {{$player->dob->format('j/n/Y')}} @endisset</span></p>
